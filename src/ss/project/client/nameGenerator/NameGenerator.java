 ...
 */
package ss.project.client.nameGenerator;
...
public class NameGenerator {
    ...
    private static final String FEMALE_NAMES_FILE = "./resources/dist.female.first.txt";
    private static final String MALE_NAMES_FILE = "./resources/dist.male.first.txt";
    private static final String SURNAMES_FILE = "./resources/dist.all.last.txt";
